-- ------------------------------------------------------------------------------
-- Database generated from DBCache on 2024-10-23 - World of Warcraft 11.0.5.56865
-- ------------------------------------------------------------------------------

if not validVersion( "11.0.5", 56865 ) then 
  return
end
...
DBC = {
  ...
  [113656] = {
    ...
    [5] = { -- (id=303680) 
      type = 2, -- School Damage
      base_value = 0,
      ap_coefficient = 1.2075,
      pvp_coefficient = 1.15,
      pct = 0.000,
    },
    [6] = { -- (id=480070) 
      type = 3, -- Dummy
  ...
  [115181] = {
    ...
    [1] = { -- (id=128879) 
      ...
      property = 17, -- Combat Reach to AOE
      base_value = 0,
      ap_coefficient = 0.5328,
      pvp_coefficient = 1.35,
      pct = 0.000,
      area_of_effect = true,
      max_targets = -1,
    },
  ...
  [137024] = {
    ...
    [10] = { -- (id=260831) 
      ...
      pct = 20.000,
      affected_spells = {
        107428,        185099,        392959,        467307,        468179,
      },
    },
    [11] = { -- (id=260832) 
      type = 6, -- Apply Aura
  ...
  [137639] = {
    ...
    [1] = { -- (id=180816) 
      ...
      affected_spells = {
        ...
        392983,        395519,        395521,        451767,        467307,
        468179,        468605,
      },
    },
    [2] = { -- (id=181516) 
  ...
  [344021] = {
    ...
    [1] = { -- (id=868060) 
      ...
      affected_spells = {
        ...
        451767,        451839,        452130,        457917,        468605,
      },
    },
    [2] = { -- (id=884941) 
      type = 6, -- Apply Aura
  ...
  [388849] = {
    ...
    [2] = { -- (id=1054746) 
      type = 6, -- Apply Aura
      subtype = 108, -- Add Percent Modifier
      property = 15, -- Spell Critical Bonus Multiplier
      ranks = { 12, 16, },
      base_value = 10,
      pvp_coefficient = 1,
      pct = 0.100,
  ...
  [450426] = {
    ...
    [2] = { -- (id=1150318) 
      ...
      pct = 0.050,
      affected_spells = {
        115175,        115310,        116670,        119611,        124507,
        124682,        130654,        132463,        162530,        178173,
        191894,        198487,        198533,        227344,        273354,
        274062,        274774,        274912,        278564,        297850,
        311123,        322101,        325209,        328748,        337268,
        337993,        343737,        343819,        345727,        358560,
  ...
  [452684] = {
    ...
    [1] = { -- (id=1154043) 
      ...
      affected_spells = {
        ...
        460478,        461404,        467307,        468179,        468605,
      },
    },
  },
  -- Wisdom of the Wall 
  ...
  [457257] = {
    ...
    [1] = { -- (id=1162132) 
      ...
      affected_spells = {
        ...
        261947,        261977,        275673,        288636,        325153,
        327264,        330903,        330911,        331433,        337342,
        345727,        387621,        388201,        388207,        388609,
        388867,        392959,        393056,        393400,        393566,
        393786,        395519,        395521,        418360,        443038,
        443088,        443127,        443263,        443611,        451767,
        451839,        452130,        457917,        468605,
      },
    },
    [2] = { -- (id=1178719) 
      type = 6, -- Apply Aura
